...
/// ```
/// # use std::time::Duration;
/// # use manteau_mailjet::MailjetConfig;
...
/// ```no_run
/// # use std::time::Duration;
/// # use manteau_mailjet::{MailjetConfig, MailjetTransport};
...
impl MailjetError {
  ...
  ///
  /// ```
  /// # use manteau_mailjet::{MailjetError, MailjetErrorKind};
...
pub enum MailjetErrorKind {
  ...
  /// underlying [`RenderError`](manteau_core::RenderError).
