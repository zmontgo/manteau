...
impl Text {
  ...
  pub fn configured_color(&self) -> Option<&Color> {
    self.color.as_ref()
  }

  /// Configured text size.
  pub fn configured_font_size(&self) -> Option<Pixels> {
    self.font_size
  }

  /// Create text content; MJML escaping occurs during serialization.
  ...
  /// Set a validated CSS font stack.
  ...
  /// Set a checked ratio or explicit line-height dimension.
  pub fn line_height(mut self, line_height: impl Into<LineHeight>) -> Self {
    self.line_height = Some(line_height.into());
    self
  }

  /// Set the spacing between rendered characters.
  pub fn letter_spacing(mut self, spacing: impl Into<Measurement>) -> Self {
    self.letter_spacing = Some(spacing.into());
    self
  }

  /// Control the rendered case of text.
...
impl Element for Text {
  fn write_mjml(&self, w: &mut MjmlWriter) {
    w.open(crate::render::ElementName::builtin("mj-text"))
      ...
      .attr(
        crate::render::AttributeName::builtin("font-family"),
      ...
      .attr(
        crate::render::AttributeName::builtin("line-height"),
        self.line_height.as_ref(),
      )
      .attr(
        crate::render::AttributeName::builtin("letter-spacing"),
        self.letter_spacing.as_ref(),
      )
      .attr(
        crate::render::AttributeName::builtin("text-transform"),
