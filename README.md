...
`MockTransport` captures immutable prepared messages. It does not report provider acceptance or delivery. [The tested examples](manteau/tests/examples/README.md) also show `mjml!`, builder composition, and conditional content.
